...
export class StoreApi extends runtime.BaseAPI {
     ...
     */
    async deleteOrderRaw(requestParameters: StoreApiDeleteOrderRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Delete purchase order by ID
     */
    async deleteOrder(requestParameters: StoreApiDeleteOrderRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     */
    async getOrderByIdRaw(requestParameters: StoreApiGetOrderByIdRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Order>> {
        if (requestParameters.orderId === null || requestParameters.orderId === undefined) {
     ...
     * Find purchase order by ID
     */
    async getOrderById(requestParameters: StoreApiGetOrderByIdRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Order> {
     ...
     */
    async placeOrderRaw(requestParameters: StoreApiPlaceOrderRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Order>> {
        ...
        const body: any = OrderToJSON(requestParameters.body),
     ...
     * Place an order for a pet
     */
    async placeOrder(requestParameters: StoreApiPlaceOrderRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Order> {
