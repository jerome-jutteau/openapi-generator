...
export class BehaviorApi extends runtime.BaseAPI {
     ...
     */
    async getBehaviorPermissionsRaw(requestParameters: GetBehaviorPermissionsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<GetBehaviorPermissionsResponse>> {
     ...
     * Get permissions for the behavior
     */
    async getBehaviorPermissions(behaviorId: number, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<GetBehaviorPermissionsResponse> {
     ...
     */
    async getBehaviorTypeRaw(requestParameters: GetBehaviorTypeRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<GetBehaviorTypeResponse>> {
        if (requestParameters.behaviorId === null || requestParameters.behaviorId === undefined) {
     ...
     * Get the type of behavior
     */
    async getBehaviorType(behaviorId: number, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<GetBehaviorTypeResponse> {
