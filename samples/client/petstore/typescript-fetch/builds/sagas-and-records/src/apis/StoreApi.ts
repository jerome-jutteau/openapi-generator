...
export class StoreApi extends runtime.BaseAPI {
     ...
     * Delete purchase order by ID
     */
    async deleteOrder(orderId: string, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<void> {
     ...
     * Find purchase order by ID
     */
    async getOrderById(orderId: number, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Order> {
     ...
     * Place an order for a pet
     */
    async placeOrder(body: Order, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Order> {
